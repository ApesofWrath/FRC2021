...
class Shooter {
    ...
    double k_P_shooter = 0.00010, k_I_shooter = 0.00001, k_D_shooter = 0.0, k_Iz_shooter = 0, k_FF_shooter = 0.000022, k_max_out_shooter = 0.95f, k_min_out_shooter = -0.95f; // Not tuned yet

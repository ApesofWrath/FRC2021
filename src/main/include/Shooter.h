...
class Shooter {
    ...
    double k_P_shooter = 0.00035, k_I_shooter = 0.00001, k_D_shooter = 0.0, k_Iz_shooter = 0, k_FF_shooter = 0.000022, k_max_out_shooter = 0.95f, k_min_out_shooter = -0.95f; // Not tuned yet
    double k_P_belt = 0.00035, k_I_belt = 0, k_D_belt = 0.0, k_Iz_belt = 0, k_FF_belt = 0.000022, k_max_out_belt = 1, k_min_out_belt = -1;
    ...
    void ConfigureTalon(TalonFX *talon, int pidSlot, int pidType, int timeoutMs, bool inverted,  
